    ...
    public class AgoraAudioCallActivity : AppCompatActivity, ISensorEventListener
    {
        ...
        private void InitBackPressed()
        {
            try
            {
                ...
                {
                    OnBackInvokedDispatcher.RegisterOnBackInvokedCallback((int)Priority.Default, new BackCallAppBase(this, "AgoraAudioCallActivity", true));
                }
                else
                {
                    OnBackPressedDispatcher.AddCallback(new BackCallAppBase(this, "AgoraAudioCallActivity", true));
                }
            }
            catch (Exception e)
            {
