    ...
    public class AgoraVideoCallActivity : AppCompatActivity 
    {
        ...
        private void InitBackPressed()
        {
            try
            {
                ...
                {
                    OnBackInvokedDispatcher.RegisterOnBackInvokedCallback((int)Priority.Default, new BackCallAppBase(this, "AgoraVideoCallActivity", true));
                }
                else
                {
                    OnBackPressedDispatcher.AddCallback(new BackCallAppBase(this, "AgoraVideoCallActivity", true));
                }
            }
            catch (Exception e)
            {
