    ...
    public class TwilioAudioCallActivity : AppCompatActivity, ISensorEventListener, TwilioVideoHelper.IListener
    {
        ...
        private void InitBackPressed()
        {
            try
            {
                ...
                {
                    OnBackInvokedDispatcher.RegisterOnBackInvokedCallback((int)Priority.Default, new BackCallAppBase(this, "TwilioAudioCallActivity", true));
                }
                else
                {
                    OnBackPressedDispatcher.AddCallback(new BackCallAppBase(this, "TwilioAudioCallActivity", true));
                }
            }
            catch (Exception e)
            {
                    ...
                    case "Twilio_audio_call":
                        {
                            ...
                            if (apiStatus == 200)
                            {
                                ...
                                TabbedMainActivity.AddCallToListAndSend("Answered", GetText(Resource.String.Lbl_Incoming), TypeCall.Audio, CallUserObject);
                            }
            ...
            RunOnUiThread(() =>
            {
                try
                {
                    if (respond == "answered")
                    {
                        ...
                        TabbedMainActivity.AddCallToListAndSend("Answered",  GetText(Resource.String.Lbl_Outgoing), TypeCall.Audio, CallUserObject);
                    }
                    ...
                    else if (respond == "calling")
                    {
                        ...
                        TabbedMainActivity.AddCallToListAndSend("Cancel",  GetText(Resource.String.Lbl_Outgoing), TypeCall.Audio, CallUserObject);
                        FinishCall();
                    }
                    else if (respond == "declined")
                    {
                        ...
                        TabbedMainActivity.AddCallToListAndSend("Cancel", GetText(Resource.String.Lbl_Missing), TypeCall.Audio, CallUserObject);
                    ...
                    else if (respond == "no_answer")
                    {
                        ...
                        TabbedMainActivity.AddCallToListAndSend("NoAnswer", GetText(Resource.String.Lbl_Missing), TypeCall.Audio, CallUserObject);
