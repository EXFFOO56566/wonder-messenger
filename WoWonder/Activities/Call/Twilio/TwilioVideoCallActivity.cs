    ...
    public class TwilioVideoCallActivity : AppCompatActivity, TwilioVideoHelper.IListener
    {
        ...
        private void InitBackPressed()
        {
            try
            {
                ...
                {
                    OnBackInvokedDispatcher.RegisterOnBackInvokedCallback((int)Priority.Default, new BackCallAppBase(this, "TwilioVideoCallActivity", true));
                }
                else
                {
                    OnBackPressedDispatcher.AddCallback(new BackCallAppBase(this, "TwilioVideoCallActivity", true));
                }
            }
            catch (Exception e)
            {
                    ...
                    case "Twilio_video_call":
                        {
                            ...
                            if (apiStatus == 200)
                            {
                                ...
                                TabbedMainActivity.AddCallToListAndSend("Answered", GetText(Resource.String.Lbl_Incoming), TypeCall.Video, CallUserObject);
                            }
            ...
            RunOnUiThread(() =>
            {
                try
                {
                    if (respond == "answered")
                    {
                        ...
                        TabbedMainActivity.AddCallToListAndSend("Answered",  GetText(Resource.String.Lbl_Outgoing), TypeCall.Video, CallUserObject);
                    }
                    ...
                    else if (respond == "calling")
                    {
                        ...
                        TabbedMainActivity.AddCallToListAndSend("Cancel",  GetText(Resource.String.Lbl_Outgoing), TypeCall.Video, CallUserObject);
                        FinishCall();
                    }
                    else if (respond == "declined")
                    {
                        ...
                        TabbedMainActivity.AddCallToListAndSend("Cancel", GetText(Resource.String.Lbl_Missing), TypeCall.Video, CallUserObject);
                    ...
                    else if (respond == "no_answer")
                    {
                        ...
                        TabbedMainActivity.AddCallToListAndSend("NoAnswer", GetText(Resource.String.Lbl_Missing), TypeCall.Video, CallUserObject);
