...
{
    public class AttachmentMediaChatBottomSheet : BottomSheetDialogFragment, MaterialDialog.IListCallback
    {
        ...
        private void CameraLayoutOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                dialogList.Title(GetString(Resource.String.Camera));
        ...
        private void GalleryLayoutOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                dialogList.Title(GetString(Resource.String.Lbl_Gallery));
                dialogList.Items(arrayAdapter);
                dialogList.NegativeText(GetText(Resource.String.Lbl_Close)).OnNegative(new MyMaterialDialog());
                dialogList.AlwaysCallSingleChoiceCallback();
                dialogList.ItemsCallback(this).Build().Show();
