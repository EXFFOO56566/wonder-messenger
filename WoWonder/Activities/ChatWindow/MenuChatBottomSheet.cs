            ...
            try
            {
                ...
                if (position > -1)
                {
                    ...
                    if (Page == "ChatWindow")
                    {
                        ...
                        {
                            ChatWindowContext.OnSelection(null, null, 0, Activity.GetText(Resource.String.Lbl_View_Profile));
                        }
                        else if (item?.Id == "2") //Block
                        { 
                            ChatWindowContext.OnSelection(null, null, 0, Activity.GetText(Resource.String.Lbl_Block));
                        }
                        else if (item?.Id == "3") //Change Chat Theme
                        {
                            ChatWindowContext.OnSelection(null, null, 0, Activity.GetText(Resource.String.Lbl_ChangeChatTheme));
                        }
                        else if (item?.Id == "4") //Wallpaper
                        {
                            ChatWindowContext.OnSelection(null, null, 0, Activity.GetText(Resource.String.Lbl_Wallpaper));
                        }
                        else if (item?.Id == "5") //Clear chat
                        {
                            ChatWindowContext.OnSelection(null, null, 0, Activity.GetText(Resource.String.Lbl_Clear_chat));
                        }
                        else if (item?.Id == "6") //StartedMessages
                        {
                            ChatWindowContext.OnSelection(null, null, 0, Activity.GetText(Resource.String.Lbl_StartedMessages));
                        }
                        else if (item?.Id == "7") //Media
                        {
                            ChatWindowContext.OnSelection(null, null, 0, Activity.GetText(Resource.String.Lbl_Media));
                        } 
                    }
                    else if (Page == "GroupChatWindow")
                    {
                        if (item?.Id == "1") //View Profile
                        {
                            GroupChatWindowContext.OnSelection(null, null, 0, Activity.GetText(Resource.String.Lbl_AddMembers));
                        }
                        else if (item?.Id == "2") //Block
                        {
                            GroupChatWindowContext.OnSelection(null, null, 0, Activity.GetText(Resource.String.Lbl_GroupInfo));
                        }
                        else if (item?.Id == "3") //Change Chat Theme
                        {
                            GroupChatWindowContext.OnSelection(null, null, 0, Activity.GetText(Resource.String.Lbl_ExitGroup));
                        }
                    } 
