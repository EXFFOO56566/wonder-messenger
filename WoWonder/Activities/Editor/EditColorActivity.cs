    ...
    public class EditColorActivity : AppCompatActivity, INiceArt.IOnSaveListener, ITextEditor, INiceArt.IOnNiceArtEditorListener
    {
        ...
        private void InitBackPressed()
        {
            try
            {
                ...
                {
                    OnBackInvokedDispatcher.RegisterOnBackInvokedCallback((int)Priority.Default, new BackCallAppBase(this, "EditColorActivity", true));
                }
                else
                {
                    OnBackPressedDispatcher.AddCallback(new BackCallAppBase(this, "EditColorActivity", true));
                }
            }
            catch (Exception e)
            {
