...
using Priority = Xamarin.Google.Android.DataTransport.Priority;
    ...
    public class StoryReplyActivity : AppCompatActivity, DragToClose.IDragListener, MaterialDialog.IListCallback, IOnRecordClickListener, IOnRecordListener
    {
        ...
        private void InitBackPressed()
        {
            try
            {
                ...
                {
                    OnBackInvokedDispatcher.RegisterOnBackInvokedCallback((int)Priority.Default, new BackCallAppBase(this, "StoryReplyActivity", true));
                }
                else
                {
                    OnBackPressedDispatcher.AddCallback(new BackCallAppBase(this, "StoryReplyActivity", true));
                }
            }
            catch (Exception e)
            {
